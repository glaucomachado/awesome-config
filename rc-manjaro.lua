...
filemanager = "exo-open --launch FileManager" or "nautilus"
gui_editor = "code"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "e", function () awful.spawn("/usr/bin/nautilus")            end,
...
awful.spawn.with_shell("~/.config/awesome/awesome-manjaro/autorun.sh")
